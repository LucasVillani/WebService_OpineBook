...
public class AvaliacaoFilme implements Serializable {
	...
	public AvaliacaoFilme(Long id, String idUsuario, Integer nota, String comentario, List<Usuario> usuariosJoinha,
			String titulo, String diretor, String elencoPrincipal, String pais, String anoLancamento, String status,
			String aprovacao) {
		super();
		this.id = id;
